...
class MovieListAdapter(private val context: Context?, private val items: List<Movie>?, private val listener: (Movie) -> Unit)
    :RecyclerView.Adapter<MovieListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_card_movie,parent,false))
    }
